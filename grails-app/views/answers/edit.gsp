...
<body>
	...
	<div id="edit-answers" class="content scaffold-edit" role="main">
		...
		<g:form method="post" >
			<g:hiddenField name="id" value="${answersInstance?.id}" />
			<g:hiddenField name="version" value="${answersInstance?.version}" />
			<fieldset class="form">
