...
<div class="fieldcontain ${hasErrors(bean: userContactsInstance, field: 'occupation', 'error')} required">
    <label for="occupation">
        <g:message code="userContacts.occupation.label" default="Occupation" />
        <span class="required-indicator">*</span>
    </label>
    <g:textField name="occupation" value="${userContactsInstance?.occupation}"/>
</div>
