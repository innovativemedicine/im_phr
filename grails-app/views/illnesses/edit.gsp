...
<body>
	...
	<div id="edit-userIllnesses" class="content scaffold-edit" role="main">
		...
		<g:form method="post" >
			<g:hiddenField name="id" value="${userIllnessesInstance?.id}" />
			<g:hiddenField name="version" value="${userIllnessesInstance?.version}" />
			<fieldset class="form">
