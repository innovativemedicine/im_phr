...
class IllnessesController {
	...
	def save() {
		...
		if (!UserIllnessesInstance.save(flush: true)) {
			flash.message = message(code: 'Error saving the entry. Please ensure the values are correct.', args: [
				message(code: 'UserIllnesses.label', default: 'UserIllnesses')
			])
	...
	def update(Long id, Long version) {
		...
		flash.message = message(code: 'Illness \"' + UserIllnessesInstance.name + '\" updated successfully', args: [
			message(code: 'UserIllnesses.label', default: 'UserIllnesses'),
			UserIllnessesInstance.id
		])
